...
<div className="max-w-6xl mx-auto">
  <CardGroup cols={3}>
    ...
    <Card title="Design System" icon="component" href="/design-system/index" cta="Explore components" arrow>
      Access our design system with live component playground and usage guidelines.
    </Card>
