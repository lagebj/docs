...
<div class="premium-callout">
  ...
  <h3>Enhanced Documentation Experience</h3>
  <p>This premium documentation includes interactive diagrams, advanced search capabilities, and exclusive case studies with detailed metrics and outcomes.</p>
</div>
...
<div class="premium-callout">
  ...
  <h3>Measurable Outcomes Framework</h3>
  <p>Our premium documentation includes a framework for measuring modernization success with leading indicators, helping teams track progress beyond just completion metrics.</p>
</div>
