...
It is a weak fit when the real ask is "please ship this for us" or when the team has no room to participate. It is also a weak fit when ownership is politically impossible, when a tool rollout is being treated as the answer (similar to our [premature tooling anti-pattern](/principles/anti-patterns#premature-tooling)), or when taper would be seen as failure rather than as the model working.
