...
Grounded Systems is built for situations where progress is needed, but the current path is producing fragility, dependence, or slow movement. Our [core principles](/principles/core-principles) help guide how we approach these challenges.
...
These improvements align with our commitment to [customer ownership](/principles/core-principles#1-customer-ownership-always) and are guided by our [entry gate checklist](/playbook/entry-gate) to ensure the conditions are right for this approach.
